...
# Generates figure object of size 5 x 9
...
The above code generates an image that cannot be rendered in pdf. To see the output, please refer to the [digital version](https://www.silviofanzon.com/2023-Differential-Geometry-Notes/sections/chap4.html) of these notes. To further customize your plots, you can check out the documentation of `go.Surface` at this [link](https://plotly.github.io/plotly.py-docs/generated/plotly.graph_objects.Surface.html).
:::