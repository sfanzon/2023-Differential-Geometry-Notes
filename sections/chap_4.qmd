...
::: Definition
### Coordinate functions on tangent plane
...
Let $\SSS$ be a regular surface and $\sss \colon U \to \SSS$ a regular chart. The **principal unit normal** to $\SSS$ is 
$$
\NN := \frac{ \sss_u \times \sss_v }{ \norm{\sss_u \times \sss_v} } \,. 
$$
...
Let $\SSS$ be a regular surface and $\sss$ be a regular chart at $\pp \in \SSS$. 
Let $(u_0,v_0)$ be such that
$$
\sss(u_0,v_0) = \pp \,.
$$
For $\vv \in T_{\pp} \SSS$ there exist
...
N := \sss_{vv} \cdot \NN \,,
$$
where $\sss_{uu}$, $\sss_{uv}$, $\sss_{vv}$ are evaluated at $(u_0,v_0)$.
The **second fundamental form** of $\sss$ is the quadratic form
$$
Q(\vv) := L \, du^2(\vv) + 2M \, du(\vv) \, dv(\vv) + N \, dv^2(\vv) \,.
$$
Denoting by 
$$
\mathcal{F}_2 = 
...
we have
$$
Q(\vv) = \vv^T \, \mathcal{F}_2 \vv \,.
$$

:::

With a little abuse of notation, we will denote $Q$ by $\mathcal{F}_2$.
