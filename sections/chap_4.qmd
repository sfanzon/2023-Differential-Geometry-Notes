...
that $\TT_d$ is actually a topology on $X$. The proof follows, line by line, the proof that the Euclidean topology is well-posed, see Definition \ref{definition-euclidean-topology}. This is left
as an exercise.



Before proceeding with examples, we need the definition of equivalent topologies.
...
We conclude our discussion on metric spaces with a useful proposition.
