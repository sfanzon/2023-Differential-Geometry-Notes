...
$$
is called the **second fundamental form** of $\SSS$. Therefore $\mathcal{F}_2$ measures how much the surface $\SSS$ deviates from being a plane. Let us give a precise definition for $\mathcal{F}_2$.
...
$$
as shown in the proof of Proposition \ref{proposition-transition-maps}. 
Therefore
$$
...
examining the behavior of the principal unit normal $\NN$. If 
$\SSS$ is a plane spanned by vectors $\pp$ and $\mathbf{q}$, then its unit normal
$$
\NN = \frac{\pp \times \mathbf{q}}{ \norm{\pp \times \mathbf{q}} } 
$$
is constant. If $\SSS$ is a general surface, measuring the variation of $\NN$ will tell us how much $\SSS$ is deviating from being a plane. This
is the idea behind the definition of Gauss map and Weingarten maps.


To introduce the Gauss map, first define by 
$$
