...
In this section we deal with **space curves**, that is, curves with values in $\R^3$. We have seen in the previous section that the signed curvature completely characterizes plane curves. A 3D counterpart of the signed curvature does not exist, since there is no notion of *turning left* or *turning right*. Moreover there exist space curves $\g$ and $\tg$ with the same curvature, but such that 
$$
\g \neq \tg \,.
$$
