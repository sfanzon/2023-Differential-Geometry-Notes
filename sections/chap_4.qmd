...
Let $\SSS$ be regular and $\pp \in \SSS$. Given a chart $\sss$ at $\pp$, we know that 
$$
T_{\pp} \SSS = \operatorname{span} \{  \sss_u, \sss_v \} \,.
$$
...
\nn := \sss_u \times \sss_v 
$$
is orthogonal to both $\sss_u$ and $\sss_v$. Hence $\nn$ is orthogonal to $T_{\pp} \SSS$. The equation for $T_{\pp} \SSS$ is then
$$
(x,y,z) \cdot \nn = k \,,
$$
