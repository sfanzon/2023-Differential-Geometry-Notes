...
\sss(u_0,v_0) = \pp \,.
$$
Let $\g \colon (-\e,\e) \to \R^3$ be a smooth curve such that
$$
...
dF_{\pp} \colon \R^2 \to \R^2 \,.
$$
Similarly, if $F \colon \SSS_1 \to \SSS_2$ is a smooth map between surfaces,
we can define its differential at $\pp \in \SSS_1$ as a linear map
$$
dF_{\pp} \colon T_{\pp} \SSS_1 \to T_{F(\pp)} \SSS_2 \,.
$$
Let us see how to precisely formulate this.
