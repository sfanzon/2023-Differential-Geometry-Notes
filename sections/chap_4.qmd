...
In particular 
$$
\widetilde{\sss} (  \alpha(u,v) , \beta(u,v) ) = \sss (f(u,v)) \,, 
...
$$
d_{\pp} ( g \circ f ) = d_{f(\p)} g \circ d_{\pp} f \,,
$$
...
We want to measure distances on a surface. The object that allows one to compute lengths, angles and areas on a surface, is the first **fundamental form** of the surface.
...
The quadratic form associated to $I_{\pp}$ is 
$$
E \, du^2 + 2F \, du \, dv + G \, dv^2 \,.
$$
...
$$
E \, du^2 + 2 F\, du \, dv + G \, dv^2 = du^2 + dv^2 \,.  
$$
...
Let $\SSS$ and $\widetilde{\SSS}$ be regular surfaces. A smooth map 
...
Let $\SSS$ and $\widetilde{\SSS}$ be regular surfaces and $f \colon \SSS \to \widetilde{\SSS}$ be smooth. They are equivalent:
...
we conclude that
$$
df_{\pp} (\vv) \cdot df_{\pp} (\ww) = \vv \cdot \ww \,, \quad  \forall \, \vv, \ww \in T_{\pp} \SSS \,,
$$
showing that $f$ is a local isometry.
...
Let $\SSS$ and $\widetilde{\SSS}$ be regular surfaces and $f \colon \SSS \to \widetilde{\SSS}$ a smooth function. They are equivalent:

1. $f$ is a local isometry.
2. Let $\sss$ be a regular chart of $\SSS$ and consider $\widetilde{\sss} = f \circ \sss$. Then $\sss$ and $\widetilde{\sss}$ have the same first fundamental form.
...
$$
Let $\sss$ be a chart for $\SSS$ at $\pp$. Define $\widetilde{\sss} = f \circ \sss$. By Proposition \ref{proposition-f-chart}, $\widetilde{\sss}$ is a regualar chart of $\widetilde{\SSS}$ at $f(\pp)$. 
Denote
$$ 
E := \sss_u \cdot \sss_v \,, \quad 
\widetilde{E} := \widetilde{\sss}_u \cdot \widetilde{\sss}_v 
$$
Now, recall the statement of Proposition \ref{proposition-differential-smooth}: if
$$
